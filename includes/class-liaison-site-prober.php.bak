...
class liaison_site_prober {
	...
	public function __construct() {
		if ( defined( 'LIAISON_SITE_PROBER_VERSION' ) ) {
			$this->version = LIAISON_SITE_PROBER_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		...
		$this->actions = new liaison_site_prober_Actions($this, $this->get_plugin_name(), $this->get_version());
	}
	...
	private function load_dependencies() {
		...
		$this->loader = new liaison_site_prober_Loader();
	...
	private function set_locale() {
		...
		//$plugin_i18n = new liaison_site_prober_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new liaison_site_prober_Admin( $this, $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new liaison_site_prober_Public( $this->get_plugin_name(), $this->get_version() );
